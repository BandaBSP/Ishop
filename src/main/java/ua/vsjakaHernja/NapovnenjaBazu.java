...
public class NapovnenjaBazu {
	...
	public void Nbazu() {
		...
		// початок оптичного привода
		OpticalDrive opticaldrive = new OpticalDrive();
		opticaldrive.setOpticalDrive(true);
		em.persist(opticaldrive);

		OpticalDrive opticaldrive1 = new OpticalDrive();
		opticaldrive1.setOpticalDrive(false);
		em.persist(opticaldrive1);
