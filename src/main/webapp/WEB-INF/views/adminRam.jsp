...
<div class="row-fluid">
	...
	<div class="row-fluid">
		...
		<form:form action="/admin/ram" class="form-inline" method="get" modelAttribute="filter">
		...
		<div class="col-md-12 col-xs-12">
			<form:form action="/admin/ram" method="post" class="form-inline" 
				...
				<div class="form-group">
					<form:input id="ramGb" path="ramGb" placeholder="ram ramGb" class="form-control" />
					<label for="ramGb"><form:errors path="ramGb" /></label>
					<button type="submit" class="btn btn-primary">Create ram</button>
				</div>
			</form:form>
		</div>
			<div class="col-md-4 col-xs-4"><h4>ram ramGb</h4></div>
